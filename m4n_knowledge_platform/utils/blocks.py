...
class SplitBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "doc-full"
        template = "components/streamfield/blocks/split_block.html"

class LargeListItem(blocks.StructBlock):
    heading = blocks.CharBlock(
        max_length=255,
        icon="title"
    )
    ...
    class Meta:
        icon = "doc-full"
        template = "components/streamfield/blocks/large_list_item.html"


class LargeListBlock(blocks.StructBlock):
    heading = blocks.CharBlock(
        icon="title"
    )

    list = blocks.ListBlock(LargeListItem())

    class Meta:
        icon = "doc-full"
        template = "components/streamfield/blocks/large_list_block.html"

class SplitListBlock(blocks.StructBlock):
    heading = blocks.CharBlock(
        icon="title"
    )

    list = blocks.ListBlock(SplitBlock())
